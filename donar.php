  ...
  <div class="container-fluid" >
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="addonor.php">Add</a></li>
    ...
    <tbody>
     <?php
      ...
      $name=$_SESSION['hospital'];
       ...
       $hid=$hids['hid'];
       if(isset($_POST['name']))
      $sql="select * from donor where hid='$hid' order by name";
      elseif(isset($_POST['age']))
       $sql="select * from donor where hid='$hid' order by age";
         elseif(isset($_POST['date']))
       $sql="select * from donor where hid='$hid' order by ddate";
        else
       $sql="select * from donor where hid='$hid' ";
      if(!$rows=$conn->query($sql))
       ...
       while($single_tuple=$rows->fetch_assoc())
       {
        ...
        <td><?php echo $single_tuple['did']; ?></td>
        ...
        <td><?php echo $single_tuple['sex']; ?></td>
         <td><?php echo $single_tuple['age']; ?></td>
          <td><?php echo $single_tuple['blood_type']; ?></td>
           <td><?php echo $single_tuple['dquantity']; ?></td>
            <td><?php echo $single_tuple['ddate']; ?></td>
            <td><?php echo $single_tuple['contact']; ?></td>
            <td><a href="update-donar.php?did=<?php echo $single_tuple['did']; ?>"><button class="btn btn-primary">Update</button></a></td>
            <td><a href="delete-donar.php?did=<?php echo $single_tuple['did']; ?>"><button class="btn btn-primary">delete</button></a></td>
      </tr>
