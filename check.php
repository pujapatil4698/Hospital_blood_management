...
<nav class="navbar navbar-inverse" style="border-radius:0px;">
  ...
  $did=$_GET['did'];
  $sql="select * from donor where did ='$did',";
  ...
  if($_SERVER['REQUEST_METHOD']=="POST")
  {
    ...
    $name=$_POST['name'];
     ...
     $contact=$_POST['contact'];
         $sql="update donor set name='$name' ,age='$age',sex='$sex',dquantity='$dquantity',ddate='$date',blood_type='$blood',contact='$contact'";
         if(!$conn->query($sql))
         die($conn->error);
   ...
   <div class="container">
     ...
     <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" >
       ...
       <div class="form-group">
         ...
         <input type="text" class="form-control" id="pwd" placeholder="Enter Age" value="<?php echo $single['age']  ?>" name="age" pattern="[1]{1}[7-9]{1}|[2-9]{1}[0-9]{1}" required>
       </div>
       <div class="form-group">
       ...
       <div class="form-group">
         ...
         <input type="text" class="form-control" id="quantity"   pattern="[1-4]{1}[0-9]{1}[0-9]{1}" value="<?php echo $single['dquantity']  ?>" placeholder="Enter Quantity" name="quantity" required>
       </div>
       <div class="form-group">
